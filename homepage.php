...
<head>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <h1>UNIVERSITY EXAMINATION MANAGEMENT PORTAL (UEMP)</h1>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
    <p style="margin:auto; font-optical-sizing:auto; position:relative; text-align: center; padding:20px; font-size:xx-large;">Department of Information Technology & Engineering</p>
<!--        <div class="row">-->
        ...
        <form  method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" id="form1">
            <div>
                ...
                <select name="Exam" title="exam" class="form-control" style="font-size:12px">
                    <option value="Day_Program">B.Tech</option>
                
                    <option value= "Masters_Program">BSC</option>
                </select><br/>
                <label>Semester</label>
                <select name="Semester" id="sem" title="Semester" class="form-control" style="font-size:12px">
                    <option value="spring">Regular</option>
                    <option value= "summer">Backlog</option>
