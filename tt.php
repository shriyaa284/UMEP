...
// var_dump($DateBe);
	...
	for($i=0;$i<10;$i++)
	{
		...
		if($i==0)
		{
		$te[$i]->name="Dr. Sanjay Shitole";
		$te[$i]->sub[0]="43";
		$te[$i]->sub[1]="31";
		}
		if($i==1)
		{
		$te[$i]->name="Prof. Rajesh Kolte";
		...
		if($i==2)
		{
		$te[$i]->name="Prof. Prakash Khelage";
		$te[$i]->sub[0]="22";
		$te[$i]->sub[1]="34";
		}
		if($i==3)
		{
		$te[$i]->name="Prof. Prachi Dhanawat";
		$te[$i]->sub[0]="41";
		$te[$i]->sub[1]="0";
		}
		if($i==4)
		{
		$te[$i]->name="Prof. Sujata Kullar";
		$te[$i]->sub[0]="25";
		$te[$i]->sub[1]="0";
		}
		if($i==5)
		{
		$te[$i]->name="Prof. Anita Morey";
		$te[$i]->sub[0]="35";
		$te[$i]->sub[1]="0";
		}
		if($i==6)
		{
		$te[$i]->name="Prof. Mohan Bonde";
		$te[$i]->sub[0]="42";
		$te[$i]->sub[1]="32";
		}
		if($i==7)
		{
		$te[$i]->name= "Prof. Rajni Nair";
		$te[$i]->sub[0]="24";
		$te[$i]->sub[1]= "44" ;
		}
		if($i==8)
		{
		$te[$i]->name="Prof. Sharmila Shetty";
		$te[$i]->sub[0]="31";
		$te[$i]->sub[1]="0";
		}
		if($i==9)
		{
		$te[$i]->name="Prof. Amruta Mahtre";
		$te[$i]->sub[0]="21";
		$te[$i]->sub[1]="0";
		}
...
<body>
<br>
<center><button onclick="window.open('index.php')">LOGOUT</button></center>
</body>
</html>