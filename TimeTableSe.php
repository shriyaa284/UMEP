        ...
        <section>
            <div class="container">
                <div class="col-md-8 col-md-push-2">
                    <div class="row">
                        <header>
                            <p style="padding:20px; font-size:30px">Time Table: SY</p>
                        </header>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <select id="termId" name="RowCount" title="RowCount" class="form-control" style="font-size:12px">
                                <option value="One" id="one">SY : UT1</option>
                                <option value="two" id="two">SY : UT2</option>
                                <option value="three" id="three">SY : SEM</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <button name="Add" onclick="addRow()" class="btn btn-dark btn-block" style="font-size:12px">Add</button>
